...
En este ejercicio, descargarás e instalarás psql y la extensión Postgres de Visual Studio Code. Si ya tienes Visual Studio Code y su extensión Postgres instalados en la máquina, puedes ir directamente a Conexión con el servidor flexible de Azure Database for PostgreSQL.
...
Puede instalar psql localmente o usar la extensión PostgreSQL de Visual Studio Code para conectarte al servidor de Azure Database for PostgreSQL.

## Uso de psql para conectarse a PostgreSQL

Si prefieres usar la línea de comandos, puedes usar la herramienta de línea de comandos psql para conectarte al servidor PostgreSQL. La herramienta de línea de comandos psql se incluye con la instalación de PostgreSQL.
...
1. En el asistente para instalación, sigue las indicaciones hasta llegar al cuadro de diálogo **Seleccionar componentes**, selecciona **Herramientas de línea de comandos**. Puedes desactivar los demás componentes si no planeas usarlos. Siga los mensajes que aparecen en pantalla para completar la instalación.
...
1. Una vez hayas comprobado que **psql** está instalado, puedes conectarte al servidor de PostgreSQL mediante la línea de comandos; para ello, abre una ventana de símbolo del sistema o terminal.
...
1. En el símbolo del sistema, escribe **`--host=<servername>.postgres.database.azure.com`** donde `<servername>` es el nombre de la instancia de Azure Database for PostgreSQL creada anteriormente.

    Puedes encontrar el nombre del servidor en **Información general** en Azure Portal o como salida del script de bicep.
...
1. Ahora que te has conectado al servidor y has creado una base de datos, puedes ejecutar consultas SQL conocidas, por ejemplo, crear tablas en la base de datos:
...
Has completado correctamente este ejercicio. Has aprendido a conectarte a PostgreSQL mediante la línea de comandos y la extensión PostgreSQL de Visual Studio Code. También has aprendido a crear una base de datos y a ejecutar consultas SQL en ella.
